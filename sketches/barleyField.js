sc1 = {
    ...
    setup:function(){
        ...
        // depthTarget = new THREE.WebGLRenderTarget(1024, 1024, renderTargetParametersRGBA);


        rgbEffect = new THREE.ShaderPass( THREE.testShader );
        // rgbEffect.uniforms['tDepth'].texture = depthTarget;

        rgbEffect.uniforms[ 'amount' ].value = 0.0;//0015;
        rgbEffect.uniforms[ 'offer' ].value = 0.0;//0015;

        // rgbEffect.material.defines = { "FLOAT_DEPTH": true };
