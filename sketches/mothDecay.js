    ...
    draw:function(time){
        ...
        if(varR){
            ...
            if(var4){
                ...
                for(var i = 0 ; i < mothShell.geometry.vertices.length ; i++){
                    flatArray.push(mothShell.geometry.vertices[i]);
                }
        ...
        if(!var1){
             if(varT){
                ...
                var ob = {zero:1,xy:0,divx:10,divy:10,off:{func:function(t){var p=0;if(t<8)p=10;return p;},points:1,freq:.5,mult:1,tipNoiseMult:5,tipNoiseFreq:.1,tipOff:-2,tipLength:2,tipPoint:0.01},
                    tubeArgs:{lengthSegs:2,widthSegs:1,minWidth:0.01,width:2}};
                var ob2 = {zero:1,xy:0,divx:10,divy:10,off:{func:function(t){var p=0;if(t<8)p=10;return p;},points:1,freq:.5,mult:1,tipNoiseMult:5,tipNoiseFreq:.1,tipOff:2,tipLength:2,tipPoint:0.01},
                    tubeArgs:{lengthSegs:2,widthSegs:1,minWidth:0.01,width:2}};
                ...
                holder.add(weave(mothParts[6],{divx:7,divy:1,zero:4,off:{skip:true},tubeArgs:{lengthSegs:7,widthSegs:1,minWidth:.1,width:.1}}));
                holder.add(weave(mothParts[7],{divx:7,divy:1,zero:4,off:{skip:true},tubeArgs:{lengthSegs:7,widthSegs:1,minWidth:.1,width:.1}}));
                holder.add(weave(mothParts[8],{divx:4,divy:1,zero:3,off:{skip:true},tubeArgs:{lengthSegs:7,widthSegs:1,minWidth:.1,width:.1}}));
                holder.add(weave(mothParts[9],{divx:4,divy:1,zero:3,off:{skip:true},tubeArgs:{lengthSegs:7,widthSegs:1,minWidth:.1,width:.1}}));
                // weave(mothParts[11],2,1);
               
                // scene.add(geo);
                for(var i = 0 ; i < mothParts.length-1 ; i++){
                    if(i>5 && i!=10) //wings
                    holder.add(mothParts[i].makeTubes({widthSegs:1,lengthSegs:6,width:.1,minWidth:.1,func:function(t){return Math.sin(((t)/2)-1.5)*2}}));
                    if(i==10)//head
                    holder.add(mothParts[i].makeTubes({widthSegs:1,lengthSegs:2,width:.1,minWidth:.1}));

                    if(i<=5)//legs
                    holder.add(mothParts[i].makeTubes({widthSegs:1,lengthSegs:2,width:.1,minWidth:.1,func:function(t){return Math.sin(t/3)*2}}));
                ...
                scene.add(mothShell);
                console.log('length')
                console.log(mothShell.geometry.vertices.length);
                scene.remove(moth); 
