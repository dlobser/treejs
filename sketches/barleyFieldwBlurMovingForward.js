sc1 = {
    ...
    setup:function(){
        ...
        for(var i = 0 ; i < 200 ; i++){
            ...
            thing.id=i;
            thing.position.x = 150-Math.random()*300;
            // thing.position.y = (50-Math.random()*100);
            thing.position.z = (50-Math.random()*700);
            thing.position.y-=30;
            scene.add(thing);
            things.push(thing);
        }
...
*/
        ...
        for(var i = 0 ; i < things.length ; i++){
            ...
            things[i].bones[1]._rotation.z = .216*2*noise(things[i].position.x/200+offset,things[i].position.y/200,things[i].position.z/200);
            things[i].position.z+=mover;
            if(things[i].position.z>350){
                things[i].position.z=-350;
            }
        }
